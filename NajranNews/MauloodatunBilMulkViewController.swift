//
//  MauloodatunBilMulkViewController.swift
//  NajranNews
//
//  Created by Najran Emarah on 15/06/1441 AH.
//  Copyright © 1441 Najran Emarah. All rights reserved.
//

import UIKit

class MauloodatunBilMulkViewController: UIViewController {

    override func viewDidLoad() {
        super.viewDidLoad()
        let documentsPath = FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask)[0]
         let destinationURL = documentsPath.appendingPathComponent("ZawajAjnabiMauloodBilMulk.txt")
