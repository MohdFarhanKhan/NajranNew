//
//  TalabIstedaaViewController.swift
//  NajranNews
//
//  Created by Najran Emarah on 14/06/1441 AH.
//  Copyright © 1441 Najran Emarah. All rights reserved.
//

import UIKit

class TalabIstedaaViewController: UIViewController {

    override func viewDidLoad() {
        super.viewDidLoad()
        let documentsPath = FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask)[0]
              
                let destinationURL = documentsPath.appendingPathComponent("TalabIstedua.txt")
