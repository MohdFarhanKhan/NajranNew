//
//  TahdeesMaloomatViewController.swift
//  NajranNews
//
...
class TahdeesMaloomatViewController: UIViewController {

    override func viewDidLoad() {
        super.viewDidLoad()
        let documentsPath = FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask)[0]
         let destinationURL = documentsPath.appendingPathComponent("TajdeedMaloomatIsterahat.txt")
